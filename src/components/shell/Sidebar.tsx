...
export function Sidebar({ open, onToggle }: { open: boolean; onToggle: () => void; }) {
  ...
  return (
    <motion.aside animate={{ width: open ? 256 : 80 }} className="fixed left-0 top-0 bottom-0 z-40 bg-white border-r border-neutral-200 shadow-sm overflow-hidden" transition={{ type: "spring", stiffness: 220, damping: 24 }}>
